...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white">
          ...
          <div className="flex items-center justify-start">
            <div className="flex-shrink-0">
              <img
                height="45px"
                width="45px"
                src="https://i.ibb.co/FgMD1sc/BookLogo.png"
                alt="logo"
              />
            </div>
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                <Link to="/">
                  <a className="text-black hover:bg-red-400 px-3 py-2 rounded-md text-sm font-medium">
                    Home
                  </a>
                </Link>
                <Link to="/all-books">
      ...
      {/* Mobile View Nav bar */}
      <div className={`${isShowMenus ? "" : "hidden"} md:hidden bg-white`}>
